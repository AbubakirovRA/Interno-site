    ...
    <div class="footer">
      <div class="footer_left">
        ...
        <div class="icons">
          ...
          <a class="instagramm icon" href="https://instagram.com">
            <svg
              width="17"
              height="16"
              viewBox="0 0 17 16"
...
export default {
  ...
  watch: {
    $route() {
      // Проверяем, находится ли текущий путь в списке страниц, на которых нужно показывать footer
      ...
      if (showFooterPages.includes(currentRoute)) {
